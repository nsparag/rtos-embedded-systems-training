...
/* Definitions for ProcessedQueue */
osMessageQueueId_t ProcessedQueueHandle;
const osMessageQueueAttr_t ProcessedQueue_attributes = {
  .name = "ProcessedQueue"
};
...
int main(void)
{
  ...
  RawQueueHandle = osMessageQueueNew (5, sizeof(uint32_t), &RawQueue_attributes);

  /* creation of ProcessedQueue */
  ProcessedQueueHandle = osMessageQueueNew (5, sizeof(uint32_t), &ProcessedQueue_attributes);
